    ...
    <nav className="">
        ...
        <div>
          <ul className="flex gap-2">
            <li className="flex items-center gap-2">
              <GoMail></GoMail>Contact
            </li>
            <li className="border-x-2 px-2 flex items-center">Help</li>
            <li className="flex items-center">FAQ</li>
          </ul>
        </div>
      ...
      <div className="flex gap-10 py-8 max-w-7xl mx-auto">
        ...
        <div className="grow">
          ...
          <p className="text-right text-blue-500 hover:text-green-500 text-sm">
            +Advanced search
          </p>
        </div>
      </div>
